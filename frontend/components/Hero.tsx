...
export default function Hero() {
    ...
    return (
        ...
        <section className="relative w-full bg-[#F8F8FD] min-h-[auto] lg:min-h-[716px]">
            ...
            {/* ── Content: same max-w-[1192px] px-6 alignment as the nav ── */}
            <div className="relative z-10 max-w-[1192px] mx-auto px-4 md:px-8 xl:px-0">

                {/* ── Hero man: inside the content container, right-aligned ── */}
                <div
                ...
                {/* Left column */}
                <div className="w-full lg:w-[65%] pt-10 pb-8 lg:pt-[82px] lg:pb-[60px]">
                    {/* Heading */}
                    <h1 className={`${clashDisplay.className} text-[#25324B] font-semibold leading-[110%] text-5xl lg:text-[72px]`}>
                        Discover <br />
                        more than <br />
            ...
            {/* Mobile: hero image inline */}
            <div className="hidden relative w-full h-[360px]">
                <Image src="/assets/hero-man-v2.png" alt="Confident man smiling" fill className="object-contain object-bottom" priority />
            </div>
            {/* ── White diagonal triangle bottom-right (Figma: Rectangle 2732) ── */}
            <div
                className="absolute hidden lg:block pointer-events-none"
                style={{
                    bottom: '0px',
