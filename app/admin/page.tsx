            ...
            <div className="flex min-h-screen">
                ...
                <main className="ml-64 flex-1 p-8">
                    ...
                    <div className="grid grid-cols-2 gap-5 mb-8">
                        <Link
                            href="/admin/jobs"
                            className="bg-[#4640DE] text-white rounded-xl p-6 flex items-center gap-4 hover:bg-[#3833b3] transition-colors group"
                        >
                        ...
                        <Link
                            ...
                            className="bg-white border border-gray-100 rounded-xl p-6 flex items-center gap-4 hover:shadow-md transition-shadow group"
                        >
                            <div className="w-12 h-12 rounded-xl bg-[#FF6550]/10 flex items-center justify-center">
